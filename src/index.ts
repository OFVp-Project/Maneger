...
import * as newDaemon from "./socketDaemon";
...
.then(() => new Promise<void>(resolve => daemon.Server.listen(5001, resolve))).then(() => console.log("Daemon Socket.io listen in port 5001"))
.then(newDaemon.listen)
